...
const BlurViewComponent = Animatable.createAnimatableComponent(BlurView)
...
var ModalBox = createReactClass({
  ...
  renderBackdrop: function () {
    ...
    if (this.props.backdrop) {
      backdrop = (
        <TouchableWithoutFeedback style={{height:'100%',width:'100%'}} onPress={this.props.backdropPressToClose ? this.close : null}>
  ...
  render: function () {
    ...
    const renderView = (
      <View>
        {visible &&!ISIOS&& this.renderBackdrop()}
          ...
          }
          {
            ISIOS
              ...
              : <BlurOverlay
                ...
                downsampling={2}
                brightness={-25}
                customStyles={styles.centerView}
                blurStyle='dark'
              >
                {renderView}
              </BlurOverlay>
